...
// LinkByNameForSetVf provides a mock function with given fields: _a0
func (_m *NetlinkManager) LinkByNameForSetVf(_a0 string) (netlink.Link, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for LinkByNameForSetVf")
	}
